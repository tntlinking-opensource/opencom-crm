...
import com.geeke.uid.dao.MyWorkerNodeDAO;
...
public class MyDisposableWorkerIdAssigner implements WorkerIdAssigner {
    ...
    @Autowired
    private MyWorkerNodeDAO myWorkerNodeDAO;
    ...
    public long assignWorkerId() {
        ...
        myWorkerNodeDAO.addWorkerNode(workerNodeEntity);
