...
<!--      listCrmCustomerProductsPage(this.search)-->
<!--        .then((responseData) => {-->
...
<!--              return item.permission === 'crmCustomerProducts:read'-->
<!--            })-->
<!--            this.permission.export = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerProducts:export'-->
<!--            })-->

<!--            this.permission.add = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerProducts:create'-->
<!--            })-->
<!--            this.permission.edit = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerProducts:update'-->
<!--            })-->
<!--            this.permission.remove = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerProducts:delete'-->
<!--            })-->
<!--          } else {-->
<!--            this.showMessage(responseData)-->
<!--          }-->
