...
<!--        <el-button type="primary" icon="el-icon-edit" v-on:click="onEdit()">添加</el-button>-->
<!--      </el-tooltip>-->
<!--      <el-tooltip v-show="permission.remove" disabled class="dc-el-tooltip_Button">-->
<!--        <el-button type="danger" icon="el-icon-delete" v-on:click="onDelete()">添加</el-button>-->
<!--      </el-tooltip>-->
<!--    </el-row>-->
<!--    <ux-grid-->
<!--      column-key-->
...
<!--import { listMyClueCrmCommunicatePage, deleteMyClueCrmCommunicate } from '@/api/crmCustomer/crmCustomerLink'-->
...
<!--              return item.permission === 'crmCustomerLink:read'-->
<!--            })-->
<!--            this.permission.export = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerLink:export'-->
<!--            })-->

<!--            this.permission.add = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerLink:create'-->
<!--            })-->
<!--            this.permission.edit = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerLink:update'-->
<!--            })-->
<!--            this.permission.remove = responseData.data.find((item) => {-->
<!--              return item.permission === 'crmCustomerLink:delete'-->
<!--            })-->
<!--          } else {-->
<!--            this.showMessage(responseData)-->
<!--          }-->
