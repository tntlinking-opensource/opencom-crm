              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item prop="cluesResponsible" label="线索负责人" class="dc-el-form-item_SingleInput">
                    <el-select
                      v-model="editFormData.cluesResponsible"
                      :style="{ width: '100%' }"
...
export default {
  ...
  methods: {
    ...
    doSave() {
      this.setLoad()
      if (validatenull(this.editFormData.cluesResponsible)){
        this.editFormData.cluesState="-1"
      }
    ...
    listCluesSourcesOptions() {
      ...
      listUserAll(dictItem).then((responseData) => {
        if (responseData.code == 100) {
