  ...
  <el-row class="dc-container" v-loading="loading">
    ...
    <el-row gutter="0" type="default" class="dc-el-row_ElRow">
      <el-tooltip  disabled class="dc-el-tooltip_Button">
        <el-button type="primary" v-on:click="onCreate">新增</el-button>
      </el-tooltip>
      <el-tooltip disabled class="dc-el-tooltip_Button">
        <el-button type="primary" v-on:click="onEdit">编辑</el-button>
      </el-tooltip>
      <el-tooltip disabled class="dc-el-tooltip_Button">
        <el-button type="danger" v-on:click="onDelete">删除</el-button>
      </el-tooltip>
      ...
      <el-tooltip style="margin-left:10px" disabled class="dc-el-tooltip_Button">
        ...
        <el-button type="primary" >其他操作</el-button>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="1">分配</el-dropdown-item>
            <el-dropdown-item command="3">合并</el-dropdown-item>
            <el-dropdown-item command="4">领取</el-dropdown-item>
            <el-dropdown-item command="2">转移线索</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-tooltip>
    </el-row>
...
import { listCrmCluesPage,listCrmCluesAll, deleteCrmClues,bulkDeleteCrmClues,saveCrmClues,importExport1 } from '@/api/myClue/crmClues'
...
export default {
  ...
  methods: {
    ...
    transfer(){
      ...
      if (this.multipleSelection[0].cluesState== "0"||this.multipleSelection[0].cluesState== "-1"||this.multipleSelection[0].cluesState== "1"||this.multipleSelection[0].cluesState== "3"){
        this.showMessage({
          type: 'success',
          msg: '选中数据目前无法转移'
        })
      ...
      this.dialog188Props.title="线索转移"
    },
    transfer1(){
      if (this.multipleSelection.length>1){
        this.showMessage({
    ...
    onEdit() {
      ...
      this.$refs.editForm.$emit('openEditDialog',this.multipleSelection[0].id)
