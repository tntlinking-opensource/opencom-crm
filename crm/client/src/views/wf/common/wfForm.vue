<template>
  <el-dialog :title='dialogProps.title' :visible.sync='dialogProps.visible' append-to-body :close-on-click-modal='false'  @open='onDialogOpen()' v-loading='loading' fullscreen :lock-scroll='true'>
    ...
    <div v-show='activeName=="form"'>
      <component ref='bizCompnent' :is='bizCompnent' :wfDaiog='this' :wfAction='dialogProps.action' :task='task' :procDef='procDef' :formKey='formKey' :bizData='bizData' :options='bizOptions' :bizParams='bizParams' v-on:after-load-data='afterLoadData' v-on:after-step-change='afterStepChange'></component>
