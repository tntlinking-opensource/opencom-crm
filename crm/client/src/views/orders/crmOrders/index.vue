      ...
      <el-row>
        <el-col :span="6">
          <el-form-item prop="customName" label="客户名称" class="dc-el-form-item_SingleInput">
            <el-input
              v-model="queryFormData.customName"
              :maxLength="120"
              placeholder="请输入客户名称"
              clearable
        ...
        <el-col :span="6">
          <el-form-item prop="bsoyName" label="商机名称" class="dc-el-form-item_SingleInput">
            <el-input
              v-model="queryFormData.bsoyName"
              :maxLength="80"
              placeholder="请输入商机名称"
              clearable
              class="dc-el-input_SingleInput"
        ...
        <el-col :span="6">
          <el-form-item prop="oedersCode" label="订单编号" class="dc-el-form-item_SingleInput">
            <el-input
              v-model="queryFormData.oedersCode"
              :maxLength="120"
              placeholder="请输入订单编号"
              clearable
              class="dc-el-input_SingleInput"
        ...
        <el-col :span="2" style="margin-left: 20px">
          <el-tooltip disabled class="dc-el-tooltip_Button">
            <el-button type="primary" icon="el-icon-search" v-on:click="onSearch" class="dc-el-button_Button">查询</el-button>
          </el-tooltip>
        </el-col>
        <el-col :span="2">
          <el-tooltip disabled class="dc-el-tooltip_Button">
...
import { listCrmOrdersPage, deleteCrmOrders } from '@/api/orders/crmOrders'
...
export default {
  ...
  data() {
    return {
      ...
      searchList: [],
      tableId: '1683007003934706550',
      schemeId: '1683007003934706548'
    }
  },
  computed: {},
  methods: {
    getList() {
      ...
      if (this.isQueryConditionPanel) {
        ...
        this.search.params.push({
          ...
          value: !validatenull(this.queryFormData.customName) ? this.queryFormData.customName : null
        })

        this.search.params.push({
          columnName: 'bsoy_name',
          queryType: 'like',

          value: !validatenull(this.queryFormData.bsoyName) ? this.queryFormData.bsoyName : null
        })

        this.search.params.push({
          columnName: 'oeders_code',
          queryType: 'like',

          value: !validatenull(this.queryFormData.oedersCode) ? this.queryFormData.oedersCode : null
        })
      }
      // 数据权限: 订单管理crm_orders
      this.pushDataPermissions(this.search.params, this.$route.meta.routerId, this.tableId)
      listCrmOrdersPage(this.search)
        .then((responseData) => {
