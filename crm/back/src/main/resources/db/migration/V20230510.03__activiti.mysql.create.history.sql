...
create table ACT_HI_PROCINST (
    ...
    PROC_INST_ID_ bigint(20) not null,
    BUSINESS_KEY_ varchar(255),
    PROC_DEF_KEY_ varchar(255),
    PROC_DEF_ID_ bigint(20) not null,
    ...
    SUPER_PROCESS_INSTANCE_ID_ bigint(20),
    ROOT_PROC_INST_ID_ bigint(20),
    SUPER_CASE_INSTANCE_ID_ bigint(20),
    CASE_INST_ID_ bigint(20),
    DELETE_REASON_ varchar(4000),
    TENANT_ID_ bigint(20),
    STATE_ varchar(255),
    primary key (ID_),
...
create table ACT_HI_ACTINST (
    ID_ bigint(20) not null,
    PARENT_ACT_INST_ID_ bigint(20),
    PROC_DEF_KEY_ varchar(255),
    PROC_DEF_ID_ bigint(20) not null,
    ROOT_PROC_INST_ID_ bigint(20),
    PROC_INST_ID_ bigint(20) not null,
    EXECUTION_ID_ bigint(20) not null,
    ACT_ID_ varchar(255) not null,
    TASK_ID_ bigint(20),
    CALL_PROC_INST_ID_ bigint(20),
    CALL_CASE_INST_ID_ bigint(20),
...
create table ACT_HI_TASKINST (
    ...
    PROC_DEF_KEY_ varchar(255),
    PROC_DEF_ID_ bigint(20),
    ROOT_PROC_INST_ID_ bigint(20),
    PROC_INST_ID_ bigint(20),
    EXECUTION_ID_ bigint(20),
    CASE_DEF_KEY_ varchar(255),
    CASE_DEF_ID_ bigint(20),
    CASE_INST_ID_ bigint(20),
    CASE_EXECUTION_ID_ bigint(20),
    ACT_INST_ID_ bigint(20),
    NAME_ varchar(255),
    PARENT_TASK_ID_ bigint(20),
...
create table ACT_HI_INCIDENT (
  ...
  CAUSE_INCIDENT_ID_ bigint(20),
  ROOT_CAUSE_INCIDENT_ID_ bigint(20),
...
create table ACT_HI_JOB_LOG (
    ...
    JOB_ID_ bigint(20) not null,
    JOB_DUEDATE_ datetime NULL,
    JOB_RETRIES_ integer,
    JOB_PRIORITY_ bigint NOT NULL DEFAULT 0,
    JOB_EXCEPTION_MSG_ varchar(4000),
    JOB_EXCEPTION_STACK_ID_ bigint(20),
    JOB_STATE_ integer,
    JOB_DEF_ID_ bigint(20),
    ...
    EXECUTION_ID_ bigint(20),
    ROOT_PROC_INST_ID_ bigint(20),
    PROCESS_INSTANCE_ID_ bigint(20),
    PROCESS_DEF_ID_ bigint(20),
...
create table ACT_HI_BATCH (
    ...
    SEED_JOB_DEF_ID_ bigint(20),
    MONITOR_JOB_DEF_ID_ bigint(20),
    BATCH_JOB_DEF_ID_ bigint(20),
...
create table ACT_HI_EXT_TASK_LOG (
    ID_ bigint(20) not null,
    TIMESTAMP_ timestamp not null,
    EXT_TASK_ID_ bigint(20) not null,
    RETRIES_ integer,
    TOPIC_NAME_ varchar(255),
    WORKER_ID_ varchar(255),
    PRIORITY_ bigint not null default 0,
    ERROR_MSG_ varchar(4000),
    ERROR_DETAILS_ID_ bigint(20),
    ACT_ID_ varchar(255),
    ACT_INST_ID_ bigint(20),
    EXECUTION_ID_ bigint(20),
    ROOT_PROC_INST_ID_ bigint(20),
