 ...
 */
@RestController
@RequestMapping(value = "/crmBusiness/crmContract")
public class CrmBusunessContractController extends BaseController {

    @Autowired
    private CrmBusunessContractService crmContractService;
    @Autowired
