...
public class NoticeSendService extends CrudService<NoticeSendDao, NoticeSend>{
     ...
     * @param files
     */
    public void sendMail(NoticeSend noticeSend, MultipartFile[] files){
       sendMail.sentEmail(noticeSend.getTitle(),noticeSend.getReceivedBy(),noticeSend.getEmailContent(),false,files);
   }
    ...
    public void  sendInfo(NoticeSend noticeSend){
        ...
        if("1".equals(noticeSend.getIsEmail())){    //邮件
            sendMail.sentEmail(noticeSend.getTitle(),noticeSend.getReceivedBy(),noticeSend.getEmailContent(),false);
        }
