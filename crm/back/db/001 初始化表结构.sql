...
CREATE TABLE `app_master_data_type` (
  ...
  `app_id` bigint(21) unsigned DEFAULT NULL COMMENT '应用',
  `default_work_model` varchar(8) NOT NULL COMMENT '默认工作模式',
  `produce_work_model` varchar(8) DEFAULT NULL COMMENT '是否支持生产者工作模式',
  `consumer_work_model` varchar(8) DEFAULT NULL COMMENT '是否支持消费者模式',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='平台主数据类型';
...
CREATE TABLE `master_data_batch_records` (
  `id` bigint(21) unsigned NOT NULL COMMENT '标识',
  `data_batch` varchar(64) DEFAULT NULL COMMENT '主数据批记录',
  `tenant_id` bigint(21) unsigned NOT NULL COMMENT '租户id',
  `master_data_type_id` bigint(21) unsigned NOT NULL COMMENT '主数据类型id',
  `source_app_id` bigint(21) DEFAULT NULL COMMENT '应用来源',
  `receive_date` datetime DEFAULT NULL COMMENT '接收时间',
  `target_app_id` text COMMENT '需要发送到应的应用',
  `push_status` varchar(8) DEFAULT NULL COMMENT '推送状态',
...
CREATE TABLE `master_data_detail` (
  ...
  `tenant_id` bigint(21) unsigned NOT NULL COMMENT '租户id',
  `master_data_type_id` bigint(21) unsigned DEFAULT NULL COMMENT '主数据类型id',
  ...
  `master_data_info_value` varchar(128) DEFAULT NULL COMMENT '字段对应值',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` varchar(64) NOT NULL COMMENT '创建者',
  `create_date` varchar(24) NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) NOT NULL COMMENT '更新者',
...
CREATE TABLE `master_data_json` (
  ...
  `update_date` varchar(24) NOT NULL COMMENT '更新时间',
  `del_flag` varchar(1) NOT NULL DEFAULT '0' COMMENT '删除标记（0：正常；1：删除）',
  `analysis` varchar(4) DEFAULT '0' COMMENT '是否校验 1：已经校验   0：未校验',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `master_data_push_records` (
  ...
  `master_data_type_id` bigint(21) unsigned NOT NULL COMMENT '主数据类型id',
  `data_key` varchar(64) NOT NULL COMMENT '主数据key',
  `data_version` varchar(16) DEFAULT NULL COMMENT '数据版本',
  `target_app_id` bigint(21) unsigned NOT NULL COMMENT '接收应用',
  `push_status` varchar(8) DEFAULT NULL COMMENT '推送状态',
  `last_send_time` datetime DEFAULT NULL COMMENT '最后发送时间',
  `push_fail_info` text COMMENT '推送失败信息',
  `push_fail_size` int(4) DEFAULT NULL COMMENT '推送失败次数',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` varchar(64) NOT NULL COMMENT '创建者',
  `create_date` varchar(24) NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) NOT NULL COMMENT '更新者',
...
CREATE TABLE `standard_field` (
  `id` bigint(21) unsigned NOT NULL COMMENT '标识',
  `master_data_type_id` bigint(21) unsigned NOT NULL COMMENT '主数据类型id',
  `data_key` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否为主键 1为主键 0不为',
  `filed_code` varchar(16) NOT NULL COMMENT '字段code',
  `filed_name` varchar(32) DEFAULT NULL COMMENT '字段名称',
  `filed_type` varchar(16) DEFAULT NULL COMMENT '字段类型',
  `filed_size` varchar(4) NOT NULL COMMENT '字段长度',
  `filed_precision` varchar(4) DEFAULT NULL COMMENT '字段精度',
  `required` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否必填 1必填  0非必填 默认必填',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` varchar(64) NOT NULL COMMENT '创建者',
  `create_date` varchar(24) NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) NOT NULL COMMENT '更新者',
...
CREATE INDEX idx_user_open_id ON sys_user ();
